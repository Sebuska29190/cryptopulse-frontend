          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-16">
              ...
              <nav className="hidden md:flex space-x-8">
                ...
                <Link href="/categories" className="text-muted hover:text-primary transition-colors duration-200">
                  Categories
                </Link>
                <Link href="/about" className="text-muted hover:text-primary transition-colors duration-200">
                  About
                </Link>
              </nav>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              <div className="col-span-1 md:col-span-2">
                <h3 className="text-xl font-bold gradient-text mb-4">Crypto Pulse Now</h3>
              ...
              <div>
                ...
                <ul className="space-y-2">
                  ...
                  <li><Link href="/categories" className="text-muted hover:text-primary transition-colors">Categories</Link></li>
              ...
              <div>
                ...
                <ul className="space-y-2">
                  <li><a href="#" className="text-muted hover:text-primary transition-colors">Bitcoin</a></li>
                  <li><a href="#" className="text-muted hover:text-primary transition-colors">Ethereum</a></li>
                  <li><a href="#" className="text-muted hover:text-primary transition-colors">DeFi</a></li>
                  <li><a href="#" className="text-muted hover:text-primary transition-colors">NFTs</a></li>
                </ul>
              </div>
            </div>
            ...
            <div className="border-t border-border mt-8 pt-8 text-center">
              <p className="text-muted">
                &copy; 2024 Crypto Pulse Now. All rights reserved.
              </p>
            </div>
          </div>
        </footer>
